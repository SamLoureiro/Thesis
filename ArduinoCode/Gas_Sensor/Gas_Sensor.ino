...
#define         MQ_PIN                       A13   //define which analog input channel you are going to use
...
#define         CALIBRATION_SAMPLE_INTERVAL  (500)   //define the time interval(in milliseconds) between each sample in the
                                                     //calibration phase
#define         READ_SAMPLE_INTERVAL         (50)    //define the time interval(in milliseconds) between each sample in 
                                                     //normal operation
